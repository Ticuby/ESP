...
parser.add_argument('--data', metavar='DIR',
                    default = 'E:\\PyTorch-Pretrained-ViT-master\\images',
...
def main():
    ...
    load_for_transfer_learning(
        model = model,checkpoint_path = 'E:\\T2T-ViT-main\\pretarined\\81.7_T2T_ViTt_14.pth.tar', use_ema = True, strict = False, num_classes = 4)
    ...
    loader_train = torch.utils.data.DataLoader(train_dataset,
                                               ...
                                               drop_last=True)
    loader_eval = torch.utils.data.DataLoader(test_dataset,
